...
import errno, glob, os, re, subprocess, threading, tempfile, platform
...
CMDS = {'Windows': {'CLOSURE_COMPILER': 'google-closure-compiler.cmd',
                     'PYTHON': 'C:\Python27\python.exe'},
        'Darwin': {'CLOSURE_COMPILER': 'closure-compiler',
                    'PYTHON':'python'}
}
for k, v in CMDS[platform.system()].items():
  locals()[k] = v
...
class Gen_compressed(threading.Thread):
  ...
  def gen_pytutor(self):
    ...
    # Read in all the source files.
    filenames = [os.path.join("..", "js", "*pytutor.js")]
  ...
  def do_compile(self, params, target_filename, filenames, remove="", extra_code=""):
    ...
    params.insert(0, CLOSURE_COMPILER)
    try:
