...
Blockly.ZoomControls.prototype.init = function(verticalSpacing) {
  ...
  this.position();
  // Reposition if the document resizes
...
Blockly.ZoomControls.prototype.dispose = function() {
  if (this.svgGroup_) {
    googl.dom.removeNode(this.svgGroup_);
  }
};
...
Blockly.ZoomControls.prototype.createZoomOutSvg_ = function(rnd) {
  ...
  */
  ...
  this.zoomOutGroup_ = Blockly.createSvgElement('g',
  ...
  zoomoutSvg.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href',
      Blockly.pathToBlockly + 'media/' + Blockly.SPRITE.url);
...
Blockly.ZoomControls.prototype.createZoomInSvg_ = function(rnd) {
  ...
  */
  var ws = this.workspace_;
  this.zoomInGroup_ = Blockly.createSvgElement('g',
      {'class': 'blocklyZoom'}, this.svgGroup_);
  var clip = Blockly.createSvgElement('clipPath',
      {
...
Blockly.ZoomControls.prototype.createZoomResetSvg_ = function(rnd) {
  ...
  */
  var ws = this.workspace_;
  this.zoomResetGroup_ = Blockly.createSvgElement('g',
      {'class': 'blocklyZoom'}, this.svgGroup_);
  var clip = Blockly.createSvgElement('clipPath',
      {
