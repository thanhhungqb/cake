...
Blockly.Msg.MAIN_BLOCK = "main with: int argc, char** argv";  // untranslated
...
Blockly.Msg.STDIO_PRINTF_TITLE = "printf %1";  // untranslated
Blockly.Msg.STDIO_SCANF_HELPURL = "https://en.wikipedia.org/wiki/Scanf_format_string";  // untranslated
Blockly.Msg.STDIO_SCANF_TITLE = "scanf %1";  // untranslated
...
Blockly.Msg.STRUCTURE_MUTATORMEM_ARRAY = "배열 type";  // untranslated
Blockly.Msg.STRUCTURE_MUTATORMEM_POINTER = "포인터 type";  // untranslated
Blockly.Msg.STRUCTURE_MUTATORMEM_VAR = "변수 type";  // untranslated
...
Blockly.Msg.TAG_COMMENT = "comment,Comment,//,/**/";  // untranslated
Blockly.Msg.TAG_DEFINE_DECLARE = "macro,constant";  // untranslated
Blockly.Msg.TAG_DEFINE_GET = "macro,constant,get";  // untranslated
Blockly.Msg.TAG_LOGIC_BOOLEAN = "boolean,true,false";  // untranslated
Blockly.Msg.TAG_LOGIC_COMPARE = "compare";  // untranslated
Blockly.Msg.TAG_LOGIC_IF = "if,if else,ifelse";  // untranslated
Blockly.Msg.TAG_LOGIC_NEGATE = "!,negate";  // untranslated
Blockly.Msg.TAG_LOGIC_NULL = "null,null character";  // untranslated
Blockly.Msg.TAG_LOGIC_OPERATION = "operation,and,or";  // untranslated
Blockly.Msg.TAG_LOGIC_SWITCH = "switch,case";  // untranslated
Blockly.Msg.TAG_LOGIC_TERNARY = "?";  // untranslated
Blockly.Msg.TAG_LOOP_FLOW = "break,continue";  // untranslated
Blockly.Msg.TAG_LOOP_FOR = "for,loop";  // untranslated
Blockly.Msg.TAG_LOOP_WHILE = "while,loop";  // untranslated
Blockly.Msg.TAG_MATH_ABS = "math.h,absolute value";  // untranslated
Blockly.Msg.TAG_MATH_ARITHMETIC = "number,arithmetic,additionsubtractionmultiplicationdivision,+-*/";  // untranslated
Blockly.Msg.TAG_MATH_EXP = "math.h,exponential function,exp()";  // untranslated
Blockly.Msg.TAG_MATH_LOGS = "math.h,log(),loge(),log10(),log2(),log e";  // untranslated
Blockly.Msg.TAG_MATH_MODULO = "arithmetic,remainder,%";  // untranslated
Blockly.Msg.TAG_MATH_NUMBER = "number";  // untranslated
Blockly.Msg.TAG_MATH_NUMCHECK = "math.h,two number check";  // untranslated
Blockly.Msg.TAG_MATH_NUMCOMPARE = "math.h,two number compare";  // untranslated
Blockly.Msg.TAG_MATH_POW = "math.h,power,pow()";  // untranslated
Blockly.Msg.TAG_MATH_ROUND = "math.h,round up,round down,round(),trunc(),ceil(),floor(),truncate";  // untranslated
Blockly.Msg.TAG_MATH_SQRT = "math.h,sqrt(),square root";  // untranslated
Blockly.Msg.TAG_MATH_TRIG = "math.h,trigonometric function,sin(),cos(),tan(),sine function,cosine function,tangent function";  // untranslated
Blockly.Msg.TAG_PROCEDURE_DEFNORETURN = "void,function";  // untranslated
Blockly.Msg.TAG_PROCEDURE_DEFRETURN = "function";  // untranslated
Blockly.Msg.TAG_STDIO_PRINTF = "stdio.h,printf(),output,out";  // untranslated
Blockly.Msg.TAG_STDIO_SCANF = "stdio.h,scanf(),input";  // untranslated
Blockly.Msg.TAG_STDIO_TEXT = "stdio.h,text";  // untranslated
Blockly.Msg.TAG_STDLIB_CONVERT = "stdlib.h,convert,atoi(),atof()";  // untranslated
Blockly.Msg.TAG_STDLIB_EXIT = "stdlib.h,exit(0),exit(1),end,the end";  // untranslated
Blockly.Msg.TAG_STDLIB_FREE = "stdlib.h,free()";  // untranslated
Blockly.Msg.TAG_STDLIB_MALLOC = "stdlib.h,malloc(),memory allocation,memory allocate";  // untranslated
Blockly.Msg.TAG_STDLIB_RAND = "stdlib.h,random number";  // untranslated
Blockly.Msg.TAG_STDLIB_SIZEOF = "stdlib.h,sizeof(),size of,sizeOf";  // untranslated
Blockly.Msg.TAG_STRING_STRCAT = "string.h,strcat(),string concatenate,concatenate string";  // untranslated
Blockly.Msg.TAG_STRING_STRCMP = "string.h,strcmp(),string compare,compare string";  // untranslated
Blockly.Msg.TAG_STRING_STRCPY = "string.h,strcpy(),string copy,copy string";  // untranslated
Blockly.Msg.TAG_STRING_STRLEN = "string.h,strlen(),string length,length of string";  // untranslated
Blockly.Msg.TAG_STRUCTURE_DECLARE = "structure,declare,define,declaration,definition";  // untranslated
Blockly.Msg.TAG_STRUCTURE_DEFINE = "structure,typedef,declare,define,declaration,definition";  // untranslated
Blockly.Msg.TAG_STRUCTURE_GET = "structure,get";  // untranslated
Blockly.Msg.TAG_STRUCTURE_SET = "structure,assignment,set";  // untranslated
Blockly.Msg.TAG_TIME_CURRENT = "time.h,get current time,print current time";  // untranslated
Blockly.Msg.TAG_TIME_REQUIREDTIME = "time.h,the time to do followings";  // untranslated
Blockly.Msg.TAG_VARIABLE_ARRAY_DECLARE = "array,declare,define,declaration,definition";  // untranslated
Blockly.Msg.TAG_VARIABLE_ARRAY_GET = "array,get";  // untranslated
Blockly.Msg.TAG_VARIABLE_ARRAY_SET = "array,assignment,set";  // untranslated
Blockly.Msg.TAG_VARIABLE_DECLARE = "variables,declare,define,declaration,definition";  // untranslated
Blockly.Msg.TAG_VARIABLE_GET = "variables,get";  // untranslated
Blockly.Msg.TAG_VARIABLE_POINTER_ADDR = "&,address";  // untranslated
Blockly.Msg.TAG_VARIABLE_POINTER_ASTR = "*,asterisk";  // untranslated
Blockly.Msg.TAG_VARIABLE_POINTER_DECLARE = "pointer,declare,define,declaration,definition";  // untranslated
Blockly.Msg.TAG_VARIABLE_POINTER_GET = "pointer,get";  // untranslated
Blockly.Msg.TAG_VARIABLE_POINTER_SET = "pointer,assignment,set";  // untranslated
Blockly.Msg.TAG_VARIABLE_SET = "variables,assignment,set";  // untranslated
...
Blockly.Msg.TIME_CURRENT_TOOLTIP = "print current time with the form '0000(year)-00(month)-00(day)-00(hour)-00(miniute)-00(seconds)'";  // untranslated
...
Blockly.Msg.VARIABLES_SET_TYPE_STRING = "string";  // untranslated
